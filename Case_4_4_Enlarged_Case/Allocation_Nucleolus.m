...
for i=1:18
    ...
    Allocation_Solution=compute_Nucleolus(Added_matrix);
    Check_Nucleolus=propensity_check(Added_matrix,Allocation_Solution);
    DP_Nucleolus(:,i)=Check_Nucleolus(end,:)';
end
Time_Nucleolus=toc;